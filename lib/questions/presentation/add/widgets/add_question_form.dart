...
import 'package:gypse_installer/questions/domain/usecase/add_requests_usecase.dart';
...
import 'package:gypse_installer/questions/presentation/add/state/add_question_state.dart';
              ...
              itemBuilder: (context, index) => [
                Row(
                  children: [
                    ...
                    const Text('Livre :', style: Font.m(color: Colors.black87)),
                    SizedBox(width: Dimensions.screen(context).width * 0.005),
                    Expanded(
                      flex: 1,
                      child: Autocomplete(
                ...
                Dimensions.m(context).paddingW(
                  GypseElevatedButton(
                    onPressed: () {
                      if (context.read<AddQuestionBloc>().onSendRequested()) {
